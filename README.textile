...
To launch Tumblefile automatically on desktop startup, do the following. From the GNOME menu, go to System > Preferences > Startup Applications. Click Add and enter 'Tumblefile' as name and '/usr/local/bin/tumblefile -m' as command<sup>1</sup>.
...
<small><sup>1</sup> This is the default installation path, those who modified the prefix at configure time should change it accordingly.</small>
