...
<pre><code>  # On Debian-based systems:
  ...
  # unpack the tumblefile "archive":http://github.com/markoa/tumblefile/downloads
...
To launch Tumblefile automatically on desktop startup, do the following. From the GNOME menu, go to System > Preferences > Startup Applications. Click Add and enter 'Tumblefile' as name and '/usr/local/bin/tumblefile -m' as command. This is the default installation path, those who modified the prefix at configure time should change it accordingly.

Tumblefile also has a minimal command line interface. From terminal, you can type
